...
public class WeatherForecast extends Entity {
    ...
    public WeatherForecast(LocalDateTime date, String city, String country, double temperature, double feelsLikeTemperature, double lowestTemperature, double highestTemperature, double windSpeed, int humidity, String weatherDescription, double latitude, double longitude) {
        this.date = date;
        this.city = city;
