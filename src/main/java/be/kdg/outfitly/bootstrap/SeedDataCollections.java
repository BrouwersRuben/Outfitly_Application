...
//        user1.setCountryCode("BE");
        ...
        User user2 = new User("testUser2@gmail.com", "test123", "Bob", "Shannon", DayOfWeek.WEDNESDAY, "0458564572", "Belgium", "BE", "Antwerp", "La Rambla", "15", "08001");
...
//                        new ClothingItem("Suit", ClothingItem.Material.SILK, ClothingItem.RainProofness.BAD,ClothingItem.Occasion.ELEGANT,ClothingItem.Weather.UNIVERSAL)));
        ...
        // Arduino API
        ArduinoSensor arduinoSensor = new ArduinoSensor(99, 300, LocalDateTime.now());
