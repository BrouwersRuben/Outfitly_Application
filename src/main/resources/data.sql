...
INSERT INTO clothes(account_id, material, clothing_type, rain_proofness, occasion, weather, image_file_path)
VALUES (1, 'material', 'type', 'rain_proofness', 'occasion', 'weather', 'file_path');
